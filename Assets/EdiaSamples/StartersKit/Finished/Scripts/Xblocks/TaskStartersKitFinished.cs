        ...
        */
        ...
        void SetupAndShowStimuli() {
            ...
            */
            ...
            ColorUtility.TryParseHtmlString(Experiment.Instance.CurrentTrial.settings.GetString("color_code"), out Color parsedColor);
            _currentStimuliColor  = parsedColor;

            Experiment.Instance.AddTrialInfoToPanel("Current color:", Experiment.Instance.CurrentTrial.settings.GetString("color_code"));
            ...
            */
            ...
            if (_currentTaskCondition == "far") {
                ...
                Experiment.Instance.ProceedWithDelay(Experiment.Instance.CurrentBlock.settings.GetFloat("timer_showcube"));
            }
            else {
                /*
...
#region STATEMACHINE OVERRIDES
        ...
        */
        ...
        public override void OnBlockStart() {
            ...
            _currentTaskCondition = Experiment.Instance.CurrentBlock.settings.GetString("task_space");
        }

        public override void OnStartTrial() {
            // Get the colors for this trial from the settings
            foreach (var colorCode in Experiment.Instance.CurrentBlock.settings.GetStringList("block_colors")) {
