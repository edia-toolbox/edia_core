...
namespace UXF.EditorUtils {
    ...
    public class UXFSessionCheck : EditorWindow {
        ...
        public void OnGUI() {
            ...
            GUILayout.Label(
                "Press the button below after generating your blocks and trials to list all blocks and trials with their associated setting in the session. This helps you make sure settings are being applied to the correct trials. ",
                labelStyle);
