...
#region DECLARATIONS
        ...
        private void OnDestroy() {
            EventManager.StopListening(Edia.Events.Settings.EvUpdateSystemSettings, OnEvUpdateSystemSettings);
            EventManager.StopListening(Edia.Events.Settings.EvRequestSystemSettings, OnEvRequestSystemSettings);
        }
