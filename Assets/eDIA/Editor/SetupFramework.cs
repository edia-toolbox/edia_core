...
namespace eDIA.EditorUtils
{
    ...
    [InitializeOnLoad]
    public class eDIAWizard : EditorWindow
    {
        ...
        [MenuItem("eDIA/Show setup wizard")]
        static void Init()
        {
            var window = (eDIAWizard) EditorWindow.GetWindow(typeof(eDIAWizard), false, "eDIA Wizard");
            window.minSize = new Vector2(300, 785);
			window.titleContent = new GUIContent("eDIA Wizard");
            window.Show();
